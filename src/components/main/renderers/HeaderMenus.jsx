    ...
    <nav>
            ...
            return (
              <div key={link.id} className="relative group">
                <div className="px-2 py-2 flex items-center">
                  <a
                    href={link.url}
                    className={`text-[13px] font-[600] whitespace-nowrap ${
                      isActive
                        ? "text-[#2d89bf]"
                  ...
                  {link.children.map((sub, subIdx) => {
                    ...
                    return (
                      <div key={sub.id || subIdx}>
                        <a
                          href={sub.url}
                          className={`block px-4 p-4 text-[12px] font-[600] ${
                            isSubActive
                              ? "text-[#2d89bf]"
                              : "text-gray-700 hover:text-[#2d89bf]"
                          }`}
      ...
      {menuOpen && (
        <>
          ...
          <div
            className={`fixed top-0 left-0 w-64 md:w-96 h-full bg-white z-40 p-6 transform transition-transform duration-300 ${
