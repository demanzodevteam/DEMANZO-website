...
const HeroTwoAnnimation = ({ image, alt }) => {
  ...
  className="bg-[#f7f7f7] w-[340px] lg:w-[380px] h-[240px] md:w-[500px] md:h-[380px] rounded-4xl absolute z-0 left-10 lg:left-16 hover:-translate-y-3.5 transition-all duration-500"
/>
