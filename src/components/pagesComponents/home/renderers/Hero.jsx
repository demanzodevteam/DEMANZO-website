...
export default function HeroSection({pageData}) {
  ...
  AOS.init();
    ...
    return (
        <>
            <div className="flex flex-col gap-4 py-8 lg:py-16 justify-center items-left" >
                <h1 className="!text-[30px] md:text-[40px] font-[600] text-[#191d27]" data-aos="zoom-in-up"> {pageData.title}</h1>
