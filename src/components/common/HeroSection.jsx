...
export default function HeroSection({ pageData }) {
  ...
  return (
    <>
      <div
        class="demanzo-container"
        style={{
          backgroundImage: pageData?.bgImg ? "none" : `url('${curveImg.src}')`,
        }}
      >
        <div className="demanzo-max-screen-width demanzo-grid">
          <div class="flex flex-col justify-center gap-4 py-8 px-4 lg:px-15 lg:py-10 text-center md:text-left">
