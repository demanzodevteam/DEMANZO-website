    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 max-w-7xl w-full overflow-hidden p-8 lg:p-14">
        ...
        <div className="flex flex-col items-center justify-center text-center gap-6 px-4">
          <img src={rocketImg.src} alt="Rocket" className="hover:-translate-y-4 transition-all duration-500" />
          <h2 className="text-3xl lg:text-4xl font-bold text-[#ffffff]">{SectionData.headings[0]}</h2>
          ...
          <img src={skyImg.src} alt="Sky" className="hover:-translate-y-4 transition-all duration-500 mt-6" />
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-10">
          <form className="space-y-6">
            ...
            {/* Dropdown */}
            <div>
              <label htmlFor="messageType" className="block mb-1 text-[#050607] text-[16px]">Reason To Contact</label>
              <select
                id="messageType"
                defaultValue=""
              ...
              >
                ...
                <option value="white-label">White Label Digital Marketing</option>
              </select>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <button
                type="submit"
                className="w-full lg:w-auto text-white bg-blue-600 px-6 py-3 rounded-full hover:bg-[#f5a31c] transition"
              >
                Request a demo
              </button>
            </div>
