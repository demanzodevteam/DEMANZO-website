...
export default function SeoFeatureSection({ pageData }) {
    ...
    return (
        ...
        <div
            className="grid grid-cols-1 lg:grid-cols-[1fr_0.8fr] px-3.5 gap-2 lg:px-3.5 lg:py-25 min-h-[80vh] mx-auto  bg-gradient-to-b from-transparent-start to-[#FEF2F2]-end"
        >
            <div className='w-full flex items-center justify-center'>
                <img src={MEDIA_URL + pageData?.images[0]?.src}
                        ...
                        <>
                            <div className='flex flex-row mb-7.5 border-b-2 border-dotted border-[#DCDCDC]'>
                                ...
                                <div className='flex flex-col'>
                                    <h3 className='text-xl text-[#191d27] font-semibold mb-5'>{data?.heading}</h3>
                                    <p className='pb-10 text-[#616670] text-[16px] font-medium'>{data?.para}</p>
                                </div>
                            </div>
                        </>
                    ))
