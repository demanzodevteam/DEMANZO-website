...
export default function SeoFeatureSection({ pageData }) {
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_0.8fr] px-3.5 gap-2 lg:px-3.5 lg:py-25 min-h-[80vh] mx-auto  bg-gradient-to-b from-transparent-start to-[#FEF2F2]-end">
