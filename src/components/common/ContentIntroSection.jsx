...
const ContentIntroSection = ({ SectionData }) => {
  ...
  return (
    <section className={`pt-16 space-y-4 ${SectionData.background}`}>
      <div className="px-4 md:px-10 lg:px-[var(--demanzo-section-spacing)] py-[var(--demanzo-section-spacing)] text-center">
