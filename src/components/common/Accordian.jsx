...
export default function FaqAccordion({ category , background}) {
  return (
    <>
      <section className={`bg-${background} py-10 px-20`}>
        ...
        <Accordion
          type="single"
          collapsible
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 px-4 md:px-10 pt-6 lg:max-w-7xl mx-auto mt-10 mb-20"
          defaultValue="item-0"
        >
