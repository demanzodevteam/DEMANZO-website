  ...
  return (
    <>
      ...
      <Accordion
        type="single"
        collapsible
        className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6 px-4 md:px-10 pt-6 lg:max-w-7xl mx-auto mt-10 mb-20"
        defaultValue="item-0"
      >
        {category.card_details?.map((faq, index) => (
          <AccordionItem value={`item-${index}`}>
            <AccordionTrigger className="text-[16px] font-[600] px-3 py-2">
              {faq.heading}
            </AccordionTrigger>
