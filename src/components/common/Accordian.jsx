...
export default function FaqAccordion({ category }) {
  return (
    <>
      <section className={`bg-${category.background} `}>
        <div className="mx-4 md:px-10 demanzo-section">
        ...
        >
          ...
          <Accordion
            type="single"
            collapsible
            className={`grid grid-cols-1 md:grid-cols-1 lg:grid-cols-${category.colVal[0]?.value} gap-4 px- md:px-10 pt-6 lg:max-w-7xl mx-auto mt-10 `}
            defaultValue="item-0"
          >
